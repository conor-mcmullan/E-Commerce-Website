<%@ Page Title="" Language="C#" MasterPageFile="~/Template.master" AutoEventWireup="true" CodeFile="ReOrderStock.aspx.cs" Inherits="Products" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <p>
        ...
        <asp:GridView ID="dgvProducts" runat="server" AutoGenerateColumns="False" OnPageIndexChanging="dgvProducts_PageIndexChanging" OnSelectedIndexChanged="dgvProducts_SelectedIndexChanged" BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px" CellPadding="3">
            ...
            <asp:CommandField ShowSelectButton="True" SelectText="<img src='../images/extra/buttons/btnReOrder.png' border=0 height=30 width=70 title='Add to cart'>"></asp:CommandField>
