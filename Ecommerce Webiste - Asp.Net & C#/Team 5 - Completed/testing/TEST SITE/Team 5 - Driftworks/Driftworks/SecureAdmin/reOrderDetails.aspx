<%@ Page Title="" Language="C#" MasterPageFile="~/Template.master" AutoEventWireup="true" CodeFile="reOrderDetails.aspx.cs" Inherits="productDetails" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <br />
    <asp:DropDownList ID="ddlStock" runat="server" ForeColor="#000000">
    ...
    &nbsp;&nbsp;&nbsp;
    <asp:ImageButton ID="btnAdd" runat="server" Text="Add to Cart" OnClick="btnAdd_Click" ImageUrl="~/images/extra/buttons/btnAddStock.png" Height="30px" Width="100px" />
    <br />
    <p>
    </p>
</asp:Content>
